...
def states_list():
    ...
    states_list = list(storage_dict.values())
    sorted_state = sorted(states_list, key=lambda state: state.name)
    return render_template('7-states_list.html', list_state=sorted_state)
